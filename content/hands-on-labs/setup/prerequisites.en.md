...
If you are using your own AWS account, be sure you have access to create and manage resources in Amazon DocumentDB and AWS Cloud9 envrionment

*After completing the workshop, remember to complete the [cleanup](/cleanup.html) section to remove any unnecessary AWS resources.*
